...
import {COMMANDS as DABLOON_COMMANDS} from './dabloon.js';
 ...
 */
export function handleChatMessage(bot, username, msg, isPm) {
  ...
  for (const handlerSet of ALL_COMMANDS) {
    ...
    return handler(bot, username, msgWithoutCommand, isPm);
  }
}
